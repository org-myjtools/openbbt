...
import org.myjtools.openbbt.core.config.GlobalConfig;
import org.myjtools.openbbt.core.persistencex.PlanNodeRepository;
...
public class GherkinPlanProvider implements PlanProvider {
	...
	public void init() {
		...
		this.idTagPattern = globalConfig.getString(GlobalConfig.ID_TAG_PATTERN).orElseThrow();
		this.definitionTag = globalConfig.getString(GlobalConfig.DEFINITION_TAG).orElseThrow();
		this.implementationTag = globalConfig.getString(GlobalConfig.IMPLEMENTATION_TAG).orElseThrow();
	}
