...
public abstract sealed class AbstractCommand implements Callable<Integer> permits BrowseCommand, InitCommand, InstallCommand, LspCommand, PlanCommand, PurgeCommand, ServeCommand, ShowConfigCommand, TuiCommand {
