package org.myjtools.openbbt.api.persistence;

import org.myjtools.openbbt.api.PlanNodeID;
import org.myjtools.openbbt.api.plan.PlanNode;
...
public interface PlanNodeRepository  {
     ...
     * @throws OpenBBTException if the id does not exist in the repository
     */
     ...
     * @throws OpenBBTException if either the parent id or the child id do not exist in the repository
     */
